...
import { RioTodoItem, Header, BdsItem, Footer, NewItem } from './components'
...
@NgModule({
  ...
  declarations: [ AppComponent, RioTodoPage, RioTodoItem, Header, Footer, BdsItem, BdsPage, NewItem ],
